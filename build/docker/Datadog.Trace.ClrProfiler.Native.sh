...
cp -f build/bin/OpenTelemetry.AutoInstrumentation.ClrProfiler.Native.${SUFIX} bin/${BUILD_TYPE}/x64/OpenTelemetry.AutoInstrumentation.ClrProfiler.Native.${SUFIX}
